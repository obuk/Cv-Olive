...
C<Cv::Pango> は、Pango を使用して、いろいろな文字を描きます。
Cv::Arr::PutText() そのものを置き換えます。
...
るので、この名前空間に cvGetTextSize() を置きます。もっと上手なパッチの
あて方をご存知の方は教えてください。
...
=item http://opencv.willowgarage.com/

=item http://github.com/obuk/Cv-Olive
